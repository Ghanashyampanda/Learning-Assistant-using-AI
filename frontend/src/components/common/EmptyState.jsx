...
const EmptyState = ({ onActionClick, title, description, buttonText }) => {
  return (
    <div className="flex flex-col items-center justify-center py-16 px-16 text-center bg-linear-to-br from-slate-50/50 to-white border border-dashed border-slate-200 rounded-3xl">
