...
const QuizManager = ({ documentId }) => {
    ...
    return (
        <div className="bg-white dark:bg-slate-800 border border-neutral-200 dark:border-slate-700 rounded-lg p-6">
                ...
                <form onSubmit={handleGenerateQuiz} className="space-y-4">
                    <div>
                        ...
                        <input
                            ...
                            min="1"
                            required
                            className="w-full h-9 px-3 border border-neutral-200 dark:border-slate-700 rounded-lg bg-white dark:bg-slate-900 text-sm text-neutral-900 dark:text-slate-100 placeholder-neutral-400 dark:placeholder-slate-500 transition-colors duration-150 focus:outline-none focus:ring-2 focus:ring-[#00d492] focus:border-transparent"
                        />
                    </div>
