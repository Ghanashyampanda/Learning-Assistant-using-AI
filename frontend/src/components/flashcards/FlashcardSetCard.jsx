    ...
    >
        <div className="space-y-4">
            ...
            <div className="flex items-start gap-4">
                ...
                <div className="flex-1 min-w-0">
                    <h3 className="text-base font-semibold text-gray-900 line-clamp-2 mb-1" title={flashcardSet?.documentId?.title}>
                        {flashcardSet?.documentId?.title}
                    </h3>
                    <p className="text-xs font-slate-500 uppercase tracking-wide">
        ...
        <div className="mt-6 pt-4 border-t border-slate-100">
          ...
          <Sparkles className="w-4 h-4" strokeWidth={2.5} />
            ...
            <div className="absolute inside-0 bg-linear-to-r from-white/0 via-white/20 to-white/0 -translate-x-full group-hover/btn:translate-x-full transition-transform duration-700" />
        </button>
    </div >
    </div >
};
