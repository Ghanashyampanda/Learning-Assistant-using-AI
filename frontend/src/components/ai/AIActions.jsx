...
const AIActions = () => {
    ...
    const handleGenerateSummary = async () => {
        ...
        try {
            ...
            setModalContent(result.data.summary);
            setIsModalOpen(true);
        } catch (error) {
    ...
    return (
        <>
                        ...
                        <form onSubmit={handleExplainConcept}>
                            ...
                            <div className="flex items-center gap-3">
                                <input
                                    ...
                                    className="flex-1 h-11 px-4 border-2 border-slate-200 rounded-xl bg-slate-50/50 text-slate-900 placeholder:text-slate-400 text-sm font-medium transition-all duration-200 focus:outline-none focus:border-emerald-500 focus:bg-white focus:shadow-lg focus:shadow-purple-500/10"
                                ...
                                <button
                                    ...
                                    className="shrink-0 h-11 px-5 bg-linear-to-r from-emerald-600 to-emerald-500 hover:from-emerald-600 hover:to-emerald-600 text-white text-sm font-semibold rounded-xl transition-all duration-200 shadow-lg shadow-emerald-500/25 disabled:opacity-50 disabled:cursor-not-allowed active:scale-95"
                                >
            ...
            <Modal
                ...
                title={modalTitle}
            >
                <div className="max-h-[60vh] overflow-y-auto prose prose-sm max-w-none prose-state ">
